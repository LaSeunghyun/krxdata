...
const CONFIGS = [
  { key: 'IS-0',  name: 'IS  고정폭 (기준)',      flags: '--to 20240920' },
  { key: 'IS-1',  name: 'IS  ATR청산 K=1',        flags: '--to 20240920 --atrexit 1' },
  { key: 'OS-0',  name: 'OOS 고정폭 (기준)',      flags: '--from 20240921' },
  { key: 'OS-1',  name: 'OOS ATR청산 K=1',        flags: '--from 20240921 --atrexit 1' },
];
...
console.log(`=== ATR 스케일 청산폭 IS/OOS · ${SEEDS.length}시드 MC (subsample 0.8) · 동시 ${CONC} ===\n`);
