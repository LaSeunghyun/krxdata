...
const CONFIGS = [
  { key: 'IS-p1',  name: 'IS  gap-pol (G1G2 trail10)', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920 --scenpolicy gap-pol.json' },
  { key: 'IS-p2',  name: 'IS  gap-pol2 (+G3 vol1.25)', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920 --scenpolicy gap-pol2.json' },
  { key: 'OS-p1',  name: 'OOS gap-pol (G1G2 trail10)', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921 --scenpolicy gap-pol.json' },
  { key: 'OS-p2',  name: 'OOS gap-pol2 (+G3 vol1.25)', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921 --scenpolicy gap-pol2.json' },
];
