...
const CONFIGS = [
  // 하드손절 폭. stoppct 99 = 사실상 손절 없음("우리 손절은 없다").
  //   맥락: rsi2 는 maxHoldR 5(5거래일 만기)가 있어 손절이 없어도 노출이 무한하지 않다.
  //   라이브 트레일손절은 2026-07-29 배포로 이미 제거됐다(rsi2 장중 개입 없음).
  //   실현 저널 21건: 트레일손절 14건 0승 -60.8%p · 하드손절 1건 -13.6%p(-7% 손절이 갭으로 2배 체결)
  //   · 부분익절 5건 5승 +33.5%p. 손실 전액이 손절류에서 나왔다.
  ...
  { key: 's99', name: 'stop 없음(99%) 모토안', file: T, extra: '--stoppct 99', grp: 'rule' },
...
console.log(`=== 하드손절 폭 ${SEEDS.length}시드 MC + 노이즈 바닥 동시측정 ===`);
