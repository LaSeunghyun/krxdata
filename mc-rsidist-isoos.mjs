...
const CONFIGS = [
  { key: 'A-IS',  name: 'A 기준 · IS  (23.01~24.09)',  flags: '--to 20240920' },
  { key: 'D2-IS', name: 'D2 거리2%+ · IS  (23.01~24.09)', flags: '--to 20240920 --rsimindist 2' },
  { key: 'A-OS',  name: 'A 기준 · OOS (24.09~26.06)',  flags: '--from 20240921' },
  { key: 'D2-OS', name: 'D2 거리2%+ · OOS (24.09~26.06)', flags: '--from 20240921 --rsimindist 2' },
];
...
console.log(`=== rsi2 목표거리 2% 필터 IS/OOS 시간분할 · ${SEEDS.length}시드 MC (subsample 0.8) · 동시 ${CONC} ===\n`);
