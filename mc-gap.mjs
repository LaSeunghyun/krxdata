...
const CONFIGS = [
  { key: 'IS-base',  name: 'IS  기준(현행)', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920' },
  { key: 'IS-pol',   name: 'IS  갭정책 trail10', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920 --scenpolicy gap-pol.json' },
  { key: 'IS-t8',    name: 'IS  갭정책 trail8', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920 --scenpolicy gap-pol-t8.json' },
  { key: 'IS-t12',   name: 'IS  갭정책 trail12', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920 --scenpolicy gap-pol-t12.json' },
  { key: 'IS-g1',    name: 'IS  갭정책 G1만', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --to 20240920 --scenpolicy gap-pol-g1only.json' },
  { key: 'OS-base',  name: 'OOS 기준(현행)', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921' },
  { key: 'OS-pol',   name: 'OOS 갭정책 trail10', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921 --scenpolicy gap-pol.json' },
  { key: 'OS-t8',    name: 'OOS 갭정책 trail8', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921 --scenpolicy gap-pol-t8.json' },
  { key: 'OS-t12',   name: 'OOS 갭정책 trail12', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921 --scenpolicy gap-pol-t12.json' },
  { key: 'OS-g1',    name: 'OOS 갭정책 G1만', re: 'combo-v2', flags: LIVE + ' --rsivol 0 --gapaxis --from 20240921 --scenpolicy gap-pol-g1only.json' },
];
