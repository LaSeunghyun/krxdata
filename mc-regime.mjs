...
const CONFIGS = [
  { key: 'A',    name: 'A 기준 (005930 프록시 SMA20/60)',      flags: '' },
  { key: 'B20',  name: 'B20 breadth MA20 top30 (0.6/0.35)',   flags: '--regimemode breadth --breadthma 20' },
  ...
  { key: 'B20a', name: 'B20a breadth MA20 전체 (0.6/0.35)',    flags: '--regimemode breadth --breadthma 20 --breadthuni all' },
  { key: 'H',    name: 'H HMA 슬로프 레짐',                    flags: '--regimemode hma' },
];
