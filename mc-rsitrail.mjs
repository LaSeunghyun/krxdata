...
const CONFIGS = [
  { key: 'A',   name: 'A 검증된 동작 (rsi2 트레일 없음)',        flags: '' },
  { key: 'T4',  name: 'T4 rsi2 트레일 4%',                     flags: '--rsitrail 4' },
  { key: 'T6',  name: 'T6 rsi2 트레일 6% (라이브 폭)',           flags: '--rsitrail 6' },
  { key: 'T10', name: 'T10 rsi2 트레일 10%',                    flags: '--rsitrail 10' },
  { key: 'B',   name: 'B 라이브 실제 (트레일6 + 부분익절6)',      flags: '--rsitrail 6 --rsitp1 6' },
];
