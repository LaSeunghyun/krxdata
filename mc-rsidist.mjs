...
const CONFIGS = [
  { key: 'A',  name: 'A 기준 (필터 없음)',        flags: '' },
  { key: 'D1', name: 'D1 MA거리 1%+ 요구',        flags: '--rsimindist 1' },
  { key: 'D2', name: 'D2 MA거리 2%+ 요구',        flags: '--rsimindist 2' },
  { key: 'D3', name: 'D3 MA거리 3%+ 요구',        flags: '--rsimindist 3' },
  { key: 'D4', name: 'D4 MA거리 4%+ 요구',        flags: '--rsimindist 4' },
  { key: 'D8', name: 'D8 MA거리 8%+ 요구',        flags: '--rsimindist 8' },
];
...
console.log(`=== rsi2 익절목표 거리 필터 (손익비) 판정 · ${SEEDS.length}시드 MC (subsample 0.8) · 동시 ${CONC} ===\n`);
